...
describe("streakCounter", () => {
	...
	it("should store streak in localStorage", () => {
		const date = new Date();
		const key = "streak";
	...
	describe("with a pre-populated streak", () => {
		...
		it("should not increment the streak if login days not consecutive", () => {
			// two days after the streak started
		...
		it("should reset if not consecutive", () => {
			...
			// skip a day to break the streak
		...
		it("should save the reset streak to localStorage", () => {
			...
			// skip a day a to break the streak
			const dateUpdated = new Date("12/15/2022");
			const streakUpdated = streakCounter(mockLocalStorage, dateUpdated)
